...
public class JFrameCafSys extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        jMenuItemChangePassword.setText("Đổi mật khẩu");
        ...
        jMenuItem8.setText("Thực đơn hôm nay");
...
//            //Invoice set input
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        int response = JOptionPane.showConfirmDialog(this, "Bạn muốn tạo mới đơn hàng?", "REFRESH", JOptionPane.YES_NO_OPTION);
        if (response == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showConfirmDialog(this, "TẠO THÀNH CÔNG.", "THÔNG BÁO", JOptionPane.PLAIN_MESSAGE);
        }
