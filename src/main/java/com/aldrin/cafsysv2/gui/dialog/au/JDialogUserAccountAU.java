...
public class JDialogUserAccountAU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextFieldFirstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 250, -1));
        ...
        getContentPane().add(jTextFieldSurname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 250, -1));
        ...
        getContentPane().add(jTextFieldPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 250, -1));
        ...
        getContentPane().add(jComboBoxRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 250, 30));
        ...
        getContentPane().add(jTextFieldUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 250, -1));

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Mật khẩu");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 180, 70, 30));

        jCheckBoxActive.setText("Kích hoạt tài khoản");
        ...
        setSize(new java.awt.Dimension(607, 347));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn lưu" + jTextFieldFirstname.getText() + " " + jTextFieldSurname.getText() + "?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            ...
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn cập nhật" + jTextFieldFirstname.getText() + " " + jTextFieldSurname.getText() + "?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                this.userAccount.setFirstname(jTextFieldFirstname.getText());
                this.userAccount.setSurname(jTextFieldSurname.getText());
                this.userAccount.setUsername(jTextFieldUsername.getText());
            ...
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn xoá" + jTextFieldFirstname.getText() + " " + jTextFieldSurname.getText() + "?", "Save confirmation", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
