...
public class JDialogMenu extends javax.swing.JDialog implements MouseListener {
    ...
    private void initComponents() {
        ...
        jTableUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên món", "Giá", "Danh mục", "Nguyên liệu chính"
            }
        ));
    ...
    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "CATEGORY ID", "TÊN MÓN", "GIÁ", "DANH MỤC", "NGUYÊN LIỆU"}, 0) {
