...
//    private static Integer selectedRo;
    ...
    private void initComponents() {
        ...
        jButtonTodaysMenu.setText("Lên đơn");
    ...
    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"MENU ID", "CATEGORY ID", "CHỌN", "DANH MỤC", "TÊN MÓN", "GIÁ", "NGUYÊN LIỆU"}, 0) {
...
//    "MENU ID", "CATEGORY ID", "TODAY'S MENU", "CATEGORY", "MENU", "PRICE", "INGREDIENTS"
    ...
    private void saveTodaysMenu() {
        int response = JOptionPane.showConfirmDialog(rootPane, "Bạn xác nhận lên thực đơn ngày hôm nay?", "Xác nhận", JOptionPane.YES_NO_OPTION);
        if (response == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(jFrameCafSys, "Thực đơn đã được lên thành công.", "Thông báo", JOptionPane.PLAIN_MESSAGE);
            this.dispose();
        }
    }
