...
public class JDialogEditPrice extends javax.swing.JDialog implements MouseListener {
    ...
    private void initComponents() {
        ...
        jButtonTodaysMenu.setText("Update");
...
//        saveTodaysMenu();
    ...
    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"TODAY'S MENU ID", "MENU ID", "TÊN", "PRICE UF", "GIÁ", "NGUYÊN LIỆU"}, 0) {
