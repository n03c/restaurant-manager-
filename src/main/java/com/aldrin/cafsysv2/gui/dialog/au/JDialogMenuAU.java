...
public class JDialogMenuAU extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn lưu?", "Save", JOptionPane.YES_NO_OPTION);
            ...
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn cập nhật?", "Update", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
                this.menu.setRecipe(jTextFieldRecipe.getText());
                this.menu.setPrice(Float.parseFloat(jTextFieldPrice.getText()));
                this.menu.setIngredients(jTextAreaIngredients.getText());
            ...
            int response = JOptionPane.showConfirmDialog(jFrameCafSys, "Bạn muốn xoá?", "Delete", JOptionPane.YES_NO_OPTION);
            if (response == JOptionPane.YES_OPTION) {
