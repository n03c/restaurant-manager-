...
public class JFrameLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 80, 140, 20));
    ...
    private void userAccessAccount() {
        ...
        if (user != null) {
            ...
            jLabelErrorMessage.setText("Kiểm tra lại tên tài khoản và mật khẩu.");
